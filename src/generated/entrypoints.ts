...
export const CURATED_ENTRYPOINTS = Object.freeze({
  ...
  Gacha: ["pool_open", "pool_size", "get_pool_state", "get_pool_states", "get_available_token_ids", "pool_registered_count", "pool_available_count", "expected_count", "escrowed_token", "get_strike_nonce", "vrf_address", "strike", "keep", "set_pool_open", "register_relic", "unregister_relic", "reset_pool", "set_vrf_address", "is_admin", "grant_admin", "revoke_admin"],
